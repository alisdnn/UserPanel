...
detekt {
    toolVersion = com.alisdnn.userpanel.buildsrc.Depends.Versions.detektVersion
...
dependencies {
    detektPlugins(com.alisdnn.userpanel.buildsrc.Depends.ClassPaths.detekt_gradle_plugin)
}
